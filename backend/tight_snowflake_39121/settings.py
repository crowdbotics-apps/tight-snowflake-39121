"""
Django settings for tight_snowflake_39121 project.
...
ROOT_URLCONF = 'tight_snowflake_39121.urls'
...
WSGI_APPLICATION = 'tight_snowflake_39121.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tight_snowflake_39121 API",
    "DESCRIPTION": "API documentation for tight_snowflake_39121 App",
    "VERSION": "v1",
}
